...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Label1.Text = Convert.ToString("計算結果 : <br><br>" + "x * x + 2 * x + 1 = " + formula1);
    }
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        Label1.Text = Convert.ToString("計算結果 : <br><br>" + "(x + y) * (x + y) + 20 = " + formula2);
    }

    protected void Button3_Click(object sender, EventArgs e)
    {
        formula3 = Convert.ToString(a * a * a + 3 * b + 5);
        Label1.Text = Convert.ToString("計算結果 : <br><br>" + "x * x * x + 3 * y + 5 = " + formula3);
    }
}
