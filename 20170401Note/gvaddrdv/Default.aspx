...
<body style = "bg-color">
	<div style = "text-align:center;">
        ...
        <hr />
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="50%" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="No" DataSourceID="SqlDataSource1" GridLines="None" HorizontalAlign="Center">
                <Fields>
