<%@ Page Title="註冊外部登入" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="test.Account.RegisterExternalLogin" Async="true" %>
