    ...
    <div style = "text-align:center;">
        <form id = "form1" runat = "server">
            ...
            <div style = "position:relative; left : 33%; text-align:left;" class = "div-topic">
                ...
                <div>
                    <div>
                    <asp:Button ID="Button1" runat="server" Text="REMOTE_HOST" class = "btn btn-primary btn-wdt" OnClick="Button1_Click" />
                        <span style="margin-left:3em"></span>
                    <asp:Button ID="Button2" runat="server" Text="SCRIPT_NAME" class = "btn btn-primary btn-wdt" OnClick="Button1_Click" />
                        <span style="margin-left:3em"></span>
                    <asp:Button ID="Button3" runat="server" Text="SERVER_SOFTWARE" class = "btn btn-primary btn-wdt" OnClick="Button1_Click" />
                    </div>
                </div>
            </div>
                <br />
