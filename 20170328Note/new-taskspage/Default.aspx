...
<asp:Content ID="Content4" ContentPlaceHolderID="idmsInputPanelArea" Runat="Server">
			...
			<div><h2>查詢</h2><br /></div>
                ...
                <asp:TextBox ID="septxtid" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                <br />
			...
			<div><h2>新增</h2><br /></div>
                編號 :<span style="margin-left:3em"></span>
                <asp:TextBox ID="intxtid" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                價格 :<span style="margin-left:3em"></span>
                <asp:TextBox ID="intxtnm" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                <br />
			...
			<div><h2>修改</h2><br /></div>
                編號 :<span style="margin-left:3em"></span>
                <asp:TextBox ID="mftxtid" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                價格 :<span style="margin-left:3em"></span>
                <asp:TextBox ID="mftxtnm" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                <br />
			...
			<div><h2>刪除</h2><br /></div>
                編號 :<span style="margin-left:3em"></span>
                <asp:TextBox ID="deletxtid" runat="server" CssClass = "btn-text" ></asp:TextBox>
                <br />
                <br />
