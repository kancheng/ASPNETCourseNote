...
<body>
    ...
    <h1> Array Practice</h1>
        ...
        &nbsp;
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="margin-top: 0px" Text="Button 1" Width="105px" />
        &nbsp;
        <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" style="margin-top: 0px" Text="Button 2" Width="105px"/>
        <br />
        <br />
